...
func TestResolveToolsAgentProfile(t *testing.T) {
	...
	expectedTools := []string{
		...
		"mem_ingest_file",     // fork enhanced: ingest PDF/DOCX/XLSX/code/text files
...
func TestResolveToolsCombinedProfiles(t *testing.T) {
	...
	// Should have all 18 tools (15 fork + 3 upstream additions: mem_current_project, mem_judge, mem_merge_projects)
	allTools := []string{
		"mem_save", "mem_search", "mem_context", "mem_session_summary",
		"mem_session_start", "mem_session_end", "mem_get_observation",
		"mem_suggest_topic_key", "mem_capture_passive", "mem_save_prompt",
		"mem_update", "mem_delete", "mem_stats", "mem_timeline", "mem_ingest_file",
		"mem_merge_projects", "mem_current_project", "mem_judge",
	}
...
func TestNewServerBackwardsCompatible(t *testing.T) {
	...
	// 14 agent + 4 admin = 18 total (fork enhanced + upstream Phase D merge)
	if len(tools) != 18 {
...
func TestProfileConsistency(t *testing.T) {
	// Verify that agent + admin = all 18 tools (fork enhanced merged with upstream Phase D)
...
func TestNewServerWithConfig(t *testing.T) {
	...
	tools := srv.ListTools()
	// Should have all 18 tools (14 agent + 4 admin: fork enhanced + upstream Phase D merge)
	if len(tools) != 18 {
